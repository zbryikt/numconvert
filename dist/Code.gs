...
var numconvert, module, onOpen, onInstall, C2c, c2C, c2a, a2cCap, a2c;
numconvert = {
...
onOpen = function(e){
  return SpreadsheetApp.getUi().createAddonMenu().addItem("轉換選取範圍 ( 中轉數 )", "c2a").addItem("轉換選取範圍 ( 數轉中/小寫 )", "a2c").addItem("轉換選取範圍 ( 數轉中/大寫 )", "a2cCap").addItem("轉換選取範圍 ( 小中轉大中  )", "c2C").addItem("轉換選取範圍 ( 大中轉小中  )", "C2c").addToUi();
};
